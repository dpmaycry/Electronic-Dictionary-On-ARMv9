...
#define rNFCMD      (*(volatile UINT8T *)0x4e000004)            //NADD Flash command
#define rNFADDR     (*(volatile UINT8T *)0x4e000008)            //NAND Flash address
#define rNFDATA     (*(volatile UINT8T *)0x4e00000c)            //NAND Flash data
...
#define rNFECC0     (*(volatile UINT8T  *)0x4e000014)
#define rNFECC1     (*(volatile UINT8T  *)0x4e000015)
#define rNFECC2     (*(volatile UINT8T  *)0x4e000016)
...
#define BIT_ADC        (0x80000000) //(0x1<<31)
