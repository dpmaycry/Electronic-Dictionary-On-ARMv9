...
#define MODE_TFT_16BIT_800480    (0x4208)
#define MODE_TFT_24BIT_640480    (0x42016)
...
#define VBPD_800480		((15)&0xff)//
#define VFPD_800480		((15)&0xff)//
#define VSPW_800480		((30) &0x3f)//
#define HBPD_800480		((30)&0x7f)//
#define HFPD_800480		((70)&0xff)//
#define HSPW_800480		((100)&0xff)//
...
/*------------------------------------------------------------------------------------------*/
//Mono
extern UINT32T (*frameBuffer1Bit)[SCR_XSIZE_STN/32];
//Gray
extern UINT32T (*frameBuffer2Bit)[SCR_XSIZE_STN/16];
extern UINT32T (*frameBuffer4Bit)[SCR_XSIZE_STN/8];
//Color STN
extern UINT32T (*frameBuffer8Bit)[SCR_XSIZE_CSTN/4];
extern UINT32T (*frameBuffer12Bit)[SCR_XSIZE_CSTN*3/8];             // The least common multiple (between 12 and 32) is 96
//TFT 240320
extern UINT32T (*frameBuffer8BitTft240320)[SCR_XSIZE_TFT_240320/4];
extern UINT32T (*frameBuffer16BitTft240320)[SCR_XSIZE_TFT_240320/2];
//TFT 640480
extern UINT32T (*frameBuffer1BitTft640480)[SCR_XSIZE_TFT_640480/32];
extern UINT32T (*frameBuffer8BitTft640480)[SCR_XSIZE_TFT_640480/4];
extern UINT32T (*frameBuffer16BitTft640480)[SCR_XSIZE_TFT_640480/2];
extern UINT32T (*frameBuffer16BitTft800480)[SCR_XSIZE_TFT_800480/2];
extern UINT32T (*frameBuffer24BitTft640480)[SCR_XSIZE_TFT_640480];  // Unpacked 24bit 
//TFT 800600
extern UINT32T (*frameBuffer1BitTft800600)[SCR_XSIZE_TFT_800600/32];
extern UINT32T (*frameBuffer8BitTft800600)[SCR_XSIZE_TFT_800600/4];
extern UINT32T (*frameBuffer16BitTft800600)[SCR_XSIZE_TFT_800600/2];
